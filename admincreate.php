      ...
      if(isset($_POST['submit'])){
          ...
          if($email_count>0){
              ...
              if($password===$cpassword){
                  $insert_query = "INSERT INTO `admin`(`name`, `email`, `password`, `cpassword`) VALUES ('$user','$email','$password','$cpassword')";
                  $query1 = mysqli_query($link,$insert_query);
                  if($query1){
                   ...
                   <?php
                    ...
                    ?>
                    <script>
                        alert("error while iserting data");
                    </script>
                   <?php
                  }
              }else{
